    ...
    <div class="col-md-4">
        <div class="team-member image-box style-2 dark-bg text-center">
            ...
            <div class="body">
                ...
                <a href="#" class="margin-clear btn btn-md-link link-light"><i class="pr-10 fa fa-phone"></i>Call</a>
                <a href="#" class="margin-clear btn btn-md-link link-light"><i class="pr-10 fa fa-envelope-o"></i>Contact</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
